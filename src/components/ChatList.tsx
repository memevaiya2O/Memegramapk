...
export default function ChatList({ chats, searchQuery, onSearchChange, onSelectChat, onOpenMenu, botToken }: ChatListProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-[#1c1c1c] transition-colors">
      {/* Header */}
      <header className="p-4 flex flex-col gap-4 bg-white dark:bg-[#1c1c1c] border-b border-gray-100 dark:border-gray-800 z-10 transition-all duration-300">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-800 dark:text-white leading-tight">Memegram</h1>
            ...
            {chats.map((chat) => (
              ...
              >
                <div className="relative">
                  ...
                  {chat.blocked && (
                    <div className="absolute -bottom-1 -right-1 bg-red-500 rounded-full p-1 border-2 border-white dark:border-[#1c1c1c]">
